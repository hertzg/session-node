    ...
    return (req, res, parsedUrl) => {
        ...
        ;(() => {
            ...
            function errorListener (err) {
                console.log('ERROR: account-node-client: ' + JSON.stringify(err))
                Error500Page(res)
            }
            ...
            var proxyReq = http.request({
                ...
                if (statusCode !== 200) {
                    console.log('ERROR: account-node-client: HTTP status code ' + statusCode)
                    Error500Page(res)
                    return
                }
                ...
                proxyRes.on('end', () => {
                    ...
                    if (response !== true) {
                        console.log('ERROR: account-node-client: Invalid response ' + JSON.stringify(response))
                        Error500Page(res)
                        return
                    }
